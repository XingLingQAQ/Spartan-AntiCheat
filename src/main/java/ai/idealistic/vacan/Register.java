...
import ai.idealistic.vacan.functionality.command.CommandTab;
import ai.idealistic.vacan.functionality.connection.JarVerification;
...
import ai.idealistic.vacan.listeners.NPCManager;
import ai.idealistic.vacan.listeners.bukkit.*;
import ai.idealistic.vacan.listeners.bukkit.standalone.*;
import ai.idealistic.vacan.utils.minecraft.entity.PlayerUtils;
import ai.idealistic.vacan.utils.minecraft.server.ProxyUtils;
