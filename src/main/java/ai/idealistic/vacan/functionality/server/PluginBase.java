...
import ai.idealistic.vacan.abstraction.inventory.implementation.ManageChecks;
import ai.idealistic.vacan.abstraction.inventory.implementation.PlayerInfo;
...
public class PluginBase {
    ...
    public static PlayerProtocol deleteProtocol(Player player) {
        if (ProtocolLib.isTemporary(player)) {
            ...
            if (protocol != null && !protocol.isAFK()) {
