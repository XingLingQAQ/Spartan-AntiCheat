...
import ai.idealistic.vacan.listeners.protocol.standalone.LegacyLagCompensationListener;

public class HitTime extends CheckDetection {

    HitTime(CheckRunner executor) {
